...
public class SkuImagesController {
    ...
    public ResponseVo<List<SkuImagesEntity>> querySkuImagesListBySkuId(@PathVariable("skuId") Long skuId){
        List<SkuImagesEntity> skuImagesEntities = skuImagesService.querySkuImagesListBySkuId(skuId);
