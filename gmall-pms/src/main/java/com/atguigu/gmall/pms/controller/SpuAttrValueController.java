...
public class  SpuAttrValueController {
    ...
    public ResponseVo<List<SpuAttrValueEntity>> querySearchAttrValueByCidAndSkuId(
            @PathVariable("cid") Long cid,
            @RequestParam("spuId")Long spuId
    ){
       List<SpuAttrValueEntity> spuAttrValueEntities = this.spuAttrValueService.querySearchAttrValueByCidAndSkuId(cid,spuId);
